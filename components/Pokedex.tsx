...
const Pokedex = () => {
  ...
  const [currentGen, setCurrentGen] = React.useState(pokemonGenerations[1]);
  ...
  const handleSetGeneration = (generation: any) => {
    setPokemonList([]); // 
    setCurrentIndex(generation.start);
  ...
  return (
    <>
      <GenerationsContainer handleSetGeneration={handleSetGeneration} />
